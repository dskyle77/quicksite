...
export const ExperienceSection = ({
  ...
  if (variant === "timeline") {
    return (
      <section
        className="mx-auto max-w-6xl px-4 sm:px-8 py-10 sm:py-16"
        id="experience"
    ...
    >
      ...
      <div className="space-y-6 sm:space-y-8">
        {items.map((item, i) => (
          <div
            key={i}
            className="flex flex-col sm:flex-row gap-2 sm:gap-6 sm:items-start relative group p-2 sm:p-0 rounded-lg sm:rounded-none border sm:border-0"
            style={{
