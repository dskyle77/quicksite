...
const gallerySchema = ({ defaultImage }: SchemaParams) => ({
  ...
  subheading: "",
  items: [
    { image: "i__workspace_modern__", imagePId: "", image2: "i__transformation_before__", image2PId: "", caption: "" },
    { image: "i__workspace_cozy__", imagePId: "", image2: "i__transformation_after__", image2PId: "", caption: "" },
  ],
});
